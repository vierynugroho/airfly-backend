  ...
  await prisma.flight.createMany({
    data: [
      ...
      },
      {
        ...
        arrivalAirport: retrievedAirports.find((a) => a.code === 'LHR').id,
        departureTime: parseISO('2024-12-27T08:00:00Z'),
        arrivalTime: parseISO('2024-12-27T10:45:00Z'),
        terminal: 'A',
        information: 'Free Wi-Fi, Complimentary Snacks',
        price: 130.0,
        class: 'ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'LHR').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'JFK').id,
        departureTime: parseISO('2024-12-27T12:00:00Z'),
        arrivalTime: parseISO('2024-12-27T18:45:00Z'),
        terminal: 'C',
        information: 'Premium Inflight Meals, Extra Legroom',
        price: 820.0,
        class: 'BUSINESS',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'JFK').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'SIN').id,
        departureTime: parseISO('2024-12-27T20:00:00Z'),
        arrivalTime: parseISO('2024-12-28T10:00:00Z'),
        terminal: 'D',
        information: 'Inflight Entertainment, Lounge Access',
        price: 670.0,
      ...
      },
      {
        ...
        airlineId: retrievedAirlines.find((a) => a.name === 'Garuda Indonesia')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'SIN').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'HND').id,
        departureTime: parseISO('2024-12-27T09:00:00Z'),
        arrivalTime: parseISO('2024-12-27T15:00:00Z'),
        terminal: 'E',
        information: 'Special Inflight Meals, Free Checked Bags',
        price: 400.0,
        class: 'ECONOMY',
      },
      {
        flightNumber: 'PR108',
        airlineId: retrievedAirlines.find((a) => a.name === 'KLM').id,
        departureAirport: retrievedAirports.find((a) => a.code === 'AMS').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'DXB').id,
        departureTime: parseISO('2024-12-27T14:00:00Z'),
        arrivalTime: parseISO('2024-12-27T20:45:00Z'),
        terminal: 'B',
        information: 'Free Wi-Fi, Complimentary Beverages',
        price: 550.0,
        class: 'BUSINESS',
      },
      {
        flightNumber: 'PR109',
        airlineId: retrievedAirlines.find((a) => a.name === 'Lufthansa').id,
        departureAirport: retrievedAirports.find((a) => a.code === 'FRA').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'LAX').id,
        departureTime: parseISO('2024-12-27T16:00:00Z'),
        arrivalTime: parseISO('2024-12-28T00:30:00Z'),
        terminal: 'F',
        information: 'Extra Legroom, Complimentary Meals',
        price: 750.0,
        class: 'BUSINESS',
      },
      {
        flightNumber: 'PR110',
        airlineId: retrievedAirlines.find((a) => a.name === 'Air Canada').id,
        departureAirport: retrievedAirports.find((a) => a.code === 'YYZ').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'ORD').id,
        departureTime: parseISO('2024-12-27T06:00:00Z'),
        arrivalTime: parseISO('2024-12-27T08:15:00Z'),
        terminal: 'C',
        information: 'Free Coffee, Inflight Entertainment',
        price: 320.0,
        class: 'ECONOMY',
      },
      {
        flightNumber: 'PR111',
        airlineId: retrievedAirlines.find((a) => a.name === 'American Airlines')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'DFW').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'MIA').id,
        departureTime: parseISO('2024-12-27T09:00:00Z'),
        arrivalTime: parseISO('2024-12-27T12:00:00Z'),
        terminal: 'E',
        information: 'Complimentary Snacks, Extra Legroom',
        price: 250.0,
        class: 'ECONOMY',
      },
      {
        flightNumber: 'PR112',
        airlineId: retrievedAirlines.find((a) => a.name === 'Delta').id,
        departureAirport: retrievedAirports.find((a) => a.code === 'ATL').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'LAX').id,
        departureTime: parseISO('2024-12-27T13:00:00Z'),
        arrivalTime: parseISO('2024-12-27T15:45:00Z'),
        terminal: 'B',
        information: 'Premium Snacks, Free Wi-Fi',
        price: 350.0,
        class: 'ECONOMY',
      },
      {
        flightNumber: 'PR113',
        airlineId: retrievedAirlines.find((a) => a.name === 'British Airways')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'LHR').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'CDG').id,
        departureTime: parseISO('2024-12-27T17:00:00Z'),
        arrivalTime: parseISO('2024-12-27T18:30:00Z'),
        terminal: 'A',
        information: 'Free Meals, Lounge Access',
        price: 200.0,
        class: 'PREMIUM ECONOMY',
      },
      {
        flightNumber: 'PR114',
        airlineId: retrievedAirlines.find((a) => a.name === 'United Airlines')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'ORD').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'DEN').id,
        departureTime: parseISO('2024-12-27T19:00:00Z'),
        arrivalTime: parseISO('2024-12-27T20:45:00Z'),
        terminal: 'D',
        information: 'Inflight Entertainment, Extra Comfort Seats',
        price: 400.0,
        class: 'ECONOMY',
      },
      {
        flightNumber: 'PR115',
        airlineId: retrievedAirlines.find((a) => a.name === 'Air France').id,
        departureAirport: retrievedAirports.find((a) => a.code === 'CDG').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'AMS').id,
        departureTime: parseISO('2024-12-27T06:30:00Z'),
        arrivalTime: parseISO('2024-12-27T07:45:00Z'),
        terminal: 'B',
        information: 'Complimentary Drinks, Free Wi-Fi',
        price: 180.0,
        class: 'ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'SIN').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'LHR').id,
        departureTime: parseISO('2024-12-27T23:00:00Z'),
        arrivalTime: parseISO('2024-12-28T06:45:00Z'),
        terminal: 'C',
        information: 'Premium Meals, Complimentary Drinks',
        price: 950.0,
        class: 'FIRST',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'SYD').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'JFK').id,
        departureTime: parseISO('2024-12-27T22:00:00Z'),
        arrivalTime: parseISO('2024-12-28T12:00:00Z'),
        terminal: 'E',
        information: 'Lounge Access, Premium Snacks',
        price: 1350.0,
        class: 'BUSINESS',
      },
      {
        flightNumber: 'PR118',
        airlineId: retrievedAirlines.find((a) => a.name === 'ANA').id,
        departureAirport: retrievedAirports.find((a) => a.code === 'HND').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'SFO').id,
        departureTime: parseISO('2024-12-27T18:00:00Z'),
        arrivalTime: parseISO('2024-12-28T10:00:00Z'),
        terminal: 'F',
        information: 'Special Inflight Meals, Lounge Access',
        price: 1200.0,
        class: 'FIRST',
      },
      {
        flightNumber: 'PR119',
        airlineId: retrievedAirlines.find((a) => a.name === 'Cathay Pacific')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'HKG').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'SIN').id,
        departureTime: parseISO('2024-12-27T11:00:00Z'),
      ...
      {
        flightNumber: 'PR120',
        airlineId: retrievedAirlines.find((a) => a.name === 'Etihad Airways')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'AUH').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'LHR').id,
        departureTime: parseISO('2024-12-27T21:00:00Z'),
        arrivalTime: parseISO('2024-12-28T04:45:00Z'),
        terminal: 'C',
        information: 'Lounge Access, Complimentary Meals',
        price: 750.0,
        class: 'BUSINESS',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'DXB').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'SYD').id,
        departureTime: parseISO('2024-12-28T22:00:00Z'),
        arrivalTime: parseISO('2024-12-29T12:00:00Z'),
        terminal: 'D',
        information: 'Inflight Entertainment, Lounge Access',
        price: 980.0,
        class: 'FIRST',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'SYD').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'LAX').id,
        departureTime: parseISO('2024-12-28T19:00:00Z'),
        arrivalTime: parseISO('2024-12-29T10:30:00Z'),
        terminal: 'E',
        information: 'Special Meals, Free Wi-Fi',
        price: 1200.0,
        class: 'BUSINESS',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'FRA').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'JFK').id,
        departureTime: parseISO('2024-12-28T08:00:00Z'),
        arrivalTime: parseISO('2024-12-28T16:00:00Z'),
        terminal: 'B',
        information: 'Complimentary Drinks, Extra Legroom',
        price: 870.0,
        class: 'PREMIUM ECONOMY',
      },
      {
        ...
        airlineId: retrievedAirlines.find((a) => a.name === 'British Airways')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'LHR').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'BOM').id,
        departureTime: parseISO('2024-12-28T22:30:00Z'),
        arrivalTime: parseISO('2024-12-29T08:00:00Z'),
        terminal: 'A',
        information: 'Inflight Entertainment, Lounge Access',
        price: 650.0,
        class: 'ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'ATL').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'JFK').id,
        departureTime: parseISO('2024-12-28T18:00:00Z'),
        arrivalTime: parseISO('2024-12-28T20:00:00Z'),
        terminal: 'C',
        information: 'Complimentary Snacks, Extra Comfort Seats',
        price: 220.0,
        class: 'ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'SIN').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'NRT').id,
        departureTime: parseISO('2024-12-28T11:00:00Z'),
        arrivalTime: parseISO('2024-12-28T17:00:00Z'),
        terminal: 'B',
        information: 'Free Inflight Meals, Lounge Access',
        price: 450.0,
        class: 'PREMIUM ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'CGK').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'SIN').id,
        departureTime: parseISO('2024-12-28T07:30:00Z'),
        arrivalTime: parseISO('2024-12-28T10:00:00Z'),
        terminal: 'A',
        information: 'Free Wi-Fi, Complimentary Snacks',
        price: 150.0,
      ...
      },
      {
        ...
        airlineId: retrievedAirlines.find((a) => a.name === 'ANA').id,
        departureAirport: retrievedAirports.find((a) => a.code === 'HND').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'BKK').id,
        departureTime: parseISO('2024-12-28T13:00:00Z'),
        arrivalTime: parseISO('2024-12-28T18:00:00Z'),
        terminal: 'D',
        information: 'Special Inflight Meals, Extra Legroom',
        price: 340.0,
        class: 'ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'HKG').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'SYD').id,
        departureTime: parseISO('2024-12-28T09:00:00Z'),
        arrivalTime: parseISO('2024-12-28T19:00:00Z'),
        terminal: 'C',
        information: 'Lounge Access, Complimentary Meals',
        price: 670.0,
        class: 'BUSINESS',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'DOH').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'JFK').id,
        departureTime: parseISO('2024-12-28T02:00:00Z'),
        arrivalTime: parseISO('2024-12-28T12:00:00Z'),
        terminal: 'A',
        information: 'Premium Snacks, Free Wi-Fi',
        price: 960.0,
      ...
      },
      {
        ...
        arrivalAirport: retrievedAirports.find((a) => a.code === 'NRT').id,
        departureTime: parseISO('2024-12-28T18:00:00Z'),
        arrivalTime: parseISO('2024-12-29T10:00:00Z'),
        terminal: 'E',
        information: 'Inflight Entertainment, Lounge Access',
        price: 920.0,
        class: 'BUSINESS',
      },
      {
        ...
        airlineId: retrievedAirlines.find((a) => a.name === 'Air Canada').id,
        departureAirport: retrievedAirports.find((a) => a.code === 'YYZ').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'YVR').id,
        departureTime: parseISO('2024-12-28T07:00:00Z'),
        arrivalTime: parseISO('2024-12-28T10:00:00Z'),
        terminal: 'B',
        information: 'Free Drinks, Complimentary Wi-Fi',
        price: 310.0,
        class: 'ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'CDG').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'JNB').id,
        departureTime: parseISO('2024-12-28T14:00:00Z'),
        arrivalTime: parseISO('2024-12-28T22:00:00Z'),
        terminal: 'F',
        information: 'Free Inflight Meals, Extra Legroom',
        price: 750.0,
        class: 'PREMIUM ECONOMY',
      },
      {
        ...
        airlineId: retrievedAirlines.find((a) => a.name === 'United Airlines')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'ORD').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'DFW').id,
        departureTime: parseISO('2024-12-28T16:30:00Z'),
        arrivalTime: parseISO('2024-12-28T19:00:00Z'),
        terminal: 'A',
        information: 'Free Wi-Fi, Complimentary Snacks',
        price: 260.0,
      ...
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'DXB').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'JFK').id,
        departureTime: parseISO('2024-12-29T02:00:00Z'),
        arrivalTime: parseISO('2024-12-29T14:30:00Z'),
        terminal: 'C',
        information: 'In-flight Entertainment-Extra Legroom',
        price: 1200.0,
        class: 'BUSINESS',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'DOH').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'LHR').id,
        departureTime: parseISO('2024-12-29T15:00:00Z'),
        arrivalTime: parseISO('2024-12-29T19:00:00Z'),
        terminal: 'D',
        information: 'Complimentary Lounge Access-WiFi',
        price: 850.0,
        class: 'ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'SIN').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'SYD').id,
        departureTime: parseISO('2024-12-30T00:30:00Z'),
        arrivalTime: parseISO('2024-12-30T10:15:00Z'),
        terminal: 'E',
        information: 'Luxury Seating-Free Meals',
        price: 1000.0,
        class: 'FIRST',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'ORD').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'MIA').id,
        departureTime: parseISO('2024-12-30T13:00:00Z'),
        arrivalTime: parseISO('2024-12-30T16:30:00Z'),
        terminal: 'F',
        information: 'WiFi Available-No Pets Allowed',
        price: 500.0,
        class: 'ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'FRA').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'LAX').id,
        departureTime: parseISO('2024-12-31T08:45:00Z'),
        arrivalTime: parseISO('2024-12-31T19:15:00Z'),
        terminal: 'G',
        information: 'In-flight Movies-Kids Meals',
        price: 1100.0,
        class: 'BUSINESS',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'LHR').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'CDG').id,
        departureTime: parseISO('2024-12-31T14:00:00Z'),
        arrivalTime: parseISO('2024-12-31T16:15:00Z'),
        terminal: 'A',
        information: 'WiFi Available-Onboard Shopping',
        price: 600.0,
        class: 'ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'CDG').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'AMS').id,
        departureTime: parseISO('2025-01-01T10:00:00Z'),
        arrivalTime: parseISO('2025-01-01T11:30:00Z'),
        terminal: 'B',
        information: 'Early Check-In Available',
        price: 450.0,
        class: 'ECONOMY',
      },
      {
        ...
        airlineId: retrievedAirlines.find((a) => a.name === 'KLM').id,
        departureAirport: retrievedAirports.find((a) => a.code === 'AMS').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'FCO').id,
        departureTime: parseISO('2025-01-01T18:00:00Z'),
        arrivalTime: parseISO('2025-01-01T20:45:00Z'),
        terminal: 'C',
        information: 'No Pets Allowed-Wheelchair Assistance Available',
        price: 550.0,
        class: 'ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'ATL').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'ORD').id,
        departureTime: parseISO('2025-01-02T05:00:00Z'),
        arrivalTime: parseISO('2025-01-02T07:00:00Z'),
        terminal: 'E',
        information: 'Free Snacks and Drinks',
        price: 700.0,
        class: 'BUSINESS',
      },
      {
        ...
        airlineId: retrievedAirlines.find((a) => a.name === 'United Airlines')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'SFO').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'SEA').id,
        departureTime: parseISO('2025-01-02T13:30:00Z'),
        arrivalTime: parseISO('2025-01-02T15:15:00Z'),
        terminal: 'G',
        information: 'Premium Economy Available',
        price: 300.0,
        class: 'ECONOMY',
      },
      {
        flightNumber: 'PR31',
        airlineId: retrievedAirlines.find((a) => a.name === 'Turkish Airlines')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'IST').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'DXB').id,
        departureTime: parseISO('2025-01-03T08:00:00Z'),
        arrivalTime: parseISO('2025-01-03T13:00:00Z'),
        terminal: 'C',
        information: 'Free WiFi-Complimentary Lounge Access',
        price: 750.0,
        class: 'BUSINESS',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'SYD').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'SIN').id,
        departureTime: parseISO('2025-01-03T22:00:00Z'),
        arrivalTime: parseISO('2025-01-04T04:30:00Z'),
        terminal: 'D',
        information: 'In-flight Movies-Free Meals',
        price: 950.0,
        class: 'FIRST',
      },
      {
        flightNumber: 'PR33',
        airlineId: retrievedAirlines.find((a) => a.name === 'Alaska Airlines')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'SEA').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'LAX').id,
        departureTime: parseISO('2025-01-04T09:00:00Z'),
        arrivalTime: parseISO('2025-01-04T11:00:00Z'),
        terminal: 'A',
        information: 'No Pets Allowed-Wheelchair Assistance Available',
        price: 350.0,
        class: 'ECONOMY',
      ...
      {
        flightNumber: 'PR34',
        airlineId: retrievedAirlines.find((a) => a.name === 'Virgin Atlantic')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'LHR').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'JFK').id,
        departureTime: parseISO('2025-01-04T18:00:00Z'),
        arrivalTime: parseISO('2025-01-04T22:00:00Z'),
        terminal: 'F',
        information: 'Luxury Seats-Onboard Shopping',
        price: 1100.0,
        class: 'FIRST',
      },
      {
        flightNumber: 'PR35',
        airlineId: retrievedAirlines.find((a) => a.name === 'ANA').id,
        departureAirport: retrievedAirports.find((a) => a.code === 'NRT').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'HND').id,
        departureTime: parseISO('2025-01-05T10:00:00Z'),
        arrivalTime: parseISO('2025-01-05T11:00:00Z'),
        terminal: 'C',
        information: 'Complimentary Snacks-Free WiFi',
        price: 200.0,
        class: 'ECONOMY',
      },
      {
        flightNumber: 'PR36',
        airlineId: retrievedAirlines.find((a) => a.name === 'Lufthansa').id,
        departureAirport: retrievedAirports.find((a) => a.code === 'MUC').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'DXB').id,
        departureTime: parseISO('2025-01-05T14:00:00Z'),
        arrivalTime: parseISO('2025-01-05T20:00:00Z'),
        terminal: 'B',
        information: 'Extra Legroom-WiFi',
        price: 850.0,
        class: 'BUSINESS',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'ATL').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'ORD').id,
        departureTime: parseISO('2025-01-05T16:30:00Z'),
        arrivalTime: parseISO('2025-01-05T18:30:00Z'),
        terminal: 'C',
        information: 'Free Snacks-In-flight Entertainment',
        price: 700.0,
        class: 'ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'CDG').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'AMS').id,
        departureTime: parseISO('2025-01-05T08:30:00Z'),
        arrivalTime: parseISO('2025-01-05T10:00:00Z'),
        terminal: 'B',
        information: 'Early Check-In Available',
        price: 500.0,
        class: 'ECONOMY',
      },
      {
        ...
        airlineId: retrievedAirlines.find((a) => a.name === 'British Airways')
          .id,
        departureAirport: retrievedAirports.find((a) => a.code === 'LHR').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'MAD').id,
        departureTime: parseISO('2025-01-05T06:45:00Z'),
        arrivalTime: parseISO('2025-01-05T09:00:00Z'),
        terminal: 'A',
        information: 'In-flight Movies-Wheelchair Assistance Available',
        price: 400.0,
        class: 'ECONOMY',
      },
      {
        ...
        departureAirport: retrievedAirports.find((a) => a.code === 'SIN').id,
        arrivalAirport: retrievedAirports.find((a) => a.code === 'HKG').id,
        departureTime: parseISO('2025-01-05T12:00:00Z'),
        arrivalTime: parseISO('2025-01-05T16:00:00Z'),
        terminal: 'D',
        information: 'Luxury Seating-Free Meals',
        price: 1050.0,
        class: 'BUSINESS',
